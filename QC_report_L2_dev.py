...
aps_cube = fits.open(
    '/work1/gcouto/weave/cube_creator/stackcube_1002022__stackcube_1002021__P001_APS_W09'
    '/stackcube_1002022__stackcube_1002021__P001_APS_cube.fits')
...
binNum, xNode, yNode, xBar, yBar, sn, nPixels, scale = voronoi_2d_binning(x_t_a, y_t_a, sgn_tt_a, rms_tt_a, targetSN,
